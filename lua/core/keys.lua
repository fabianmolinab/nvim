...
-- Git Diff View
a.nvim_set_keymap('n', '<leader>df', ':DiffviewOpen<CR>', {noremap = true})
a.nvim_set_keymap('n', '<leader>dx', ':DiffviewClose<CR>', {noremap = true})
...
a.nvim_set_keymap('n', '<leader>hj', ':Gitsigns preview_hunk<CR>', { noremap = true })
