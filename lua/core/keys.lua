...
a.nvim_set_keymap('n', '<right>', ':vertical resize +5<CR>',
                  {noremap = true, silent = true})
a.nvim_set_keymap('n', '<left>', ':vertical resize -5<CR>',
                  {noremap = true, silent = true})
a.nvim_set_keymap('n', '<up>', ':resize +5<CR>', {noremap = true, silent = true})
a.nvim_set_keymap('n', '<down>', ':resize -5<CR>',
                  {noremap = true, silent = true})
...
-- Navegación con Tmux
a.nvim_set_keymap('n', '<C-h>', ':TmuxNavigateLeft<CR>',
                  {noremap = true, silent = true})
a.nvim_set_keymap('n', '<C-j>', ':TmuxNavigateDown<CR>',
                  {noremap = true, silent = true})
a.nvim_set_keymap('n', '<C-k>', ':TmuxNavigateUp<CR>',
                  {noremap = true, silent = true})
a.nvim_set_keymap('n', '<C-l>', ':TmuxNavigateRight<CR>',
                  {noremap = true, silent = true})
...
------ Telescope
-- Buscar archivos
a.nvim_set_keymap('n', '<Leader>f',
                  '<cmd>lua require(\'telescope.builtin\').find_files()<cr>',
                  {noremap = true})
-- Buscar dentro del proyecto cualquier palabra
a.nvim_set_keymap('n', '<Leader>a',
                  '<cmd>lua require(\'telescope.builtin\').live_grep()<cr>',
                  {noremap = true})
a.nvim_set_keymap('n', '<Leader>mf',
                  '<cmd>lua require(\'telescope.builtin\').marks()<cr>',
                  {noremap = true})
-- Lista de commits
a.nvim_set_keymap('n', '<Leader>co',
                  '<cmd>lua require(\'telescope.builtin\').git_commits()<cr>',
                  {noremap = true})
-- Buscar archivos de git
a.nvim_set_keymap('n', '<Leader>ag',
                  '<cmd>lua require(\'telescope.builtin\').git_files()<cr>',
                  {noremap = true})
-- Lista los archivos o ventanas cerradas
a.nvim_set_keymap('n', '<Leader>of',
                  '<cmd>lua require(\'telescope.builtin\').oldfiles()<cr>',
                  {noremap = true})
-- Lista buffers o pestañas abiertos
a.nvim_set_keymap('n', '<Leader>b',
...
a.nvim_set_keymap('n', '<leader>hs', ':Gitsigns stage_hunk<CR>',
                  {noremap = true})
a.nvim_set_keymap('n', '<leader>hu', ':Gitsigns undo_stage_hunk<CR>',
                  {noremap = true})
--  Git Stage entre lineas
a.nvim_set_keymap('v', '<leader>hs', ':Gitsigns stage_hunk<CR>',
                  {noremap = true})
a.nvim_set_keymap('n', '<leader>hu', ':Gitsigns undo_stage_hunk<CR>',
                  {noremap = true})
-- GitSigns Preview: "Muestra una previsualización de los cambios entre lineas
a.nvim_set_keymap('n', '<leader>hp', ':Gitsigns preview_hunk<CR>',
                  {noremap = true})
...
-- Debuger
a.nvim_set_keymap('n', '<leader>db', ':DapToggleBreakpoint<CR>',
                  {noremap = true}) -- Punto de espera
...
a.nvim_set_keymap('n', '<leader>du', ':lua require("dapui").toggle()<CR>',
                  {noremap = true})
